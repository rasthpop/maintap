...
export default function MenuButtons(){
    return(
        ...
        <div className="w-[382px] h-[84.42px]">
          ...
          {/* <div className="bg-blue-300 cursor-pointer w-[59px] h-[45px] absolute top-[660px] left-[22px] z-40 opacity-50">Leaders</div>
          ...
          <div className="w-[139px] h-[48.25px]">
            ...
            <img
              src="src/assets/ресурс-3@2x-1.png"
          ...
          <div className="w-[38px] h-9 absolute left-[304px] top-[662px] overflow-hidden bg-[url('src/assets/ресурс-5-1.png')] bg-cover bg-no-repeat bg-center" />
        </div>
        <img src="src/assets/звезда-1.png" className="w-9 h-9 absolute left-[32.5px] top-[661.5px] object-cover" />
      </div> 
    )
}